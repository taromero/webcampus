...
(function($, mango, undefined){
	...
	mango.loaded(function(){
		...
		$('input:checkbox').checkbox({
			cls : 'checkbox',
			empty : 'images/elements/checkbox/empty.png'
		});
	...
	mango.ready(function(){
		...
		mango.utils.preload([
			'images/layout/navigation/arrow-active.png',
			'images/layout/navigation/arrow-hover.png',
			'images/layout/navigation/arrow.png',
			'images/layout/navigation/bg-current.png',
			'images/layout/navigation/bg-active.png',
			'images/layout/navigation/bg-hover.png',
			'images/layout/navigation/bg-normal.png'
		]);
		
		mango.utils.preload([
			'images/layout/sidebar/bg-right.png',
			'images/layout/sidebar/bg.png',
			'images/layout/sidebar/divider.png',
			'images/layout/sidebar/shadow-right.png',
			'images/layout/sidebar/shadow.png',
			'images/layout/sidebar-right/header-bg.png',
			'images/layout/sidebar-right/nav-bg-hover.png',
			'images/layout/sidebar-right/nav-bg.png'
		]);
		
		mango.utils.preload([
			'images/layout/toolbar/bg.png',
			'images/layout/toolbar/buttons/bg-active.png',
			'images/layout/toolbar/buttons/bg-disabled.png',
			'images/layout/toolbar/buttons/bg-hover.png',
			'images/layout/toolbar/buttons/bg-red-active.png',
			'images/layout/toolbar/buttons/bg-red-disabled.png',
			'images/layout/toolbar/buttons/bg-red-hover.png',
			'images/layout/toolbar/buttons/bg-red.png',
			'images/layout/toolbar/buttons/bg.png',
			'images/layout/toolbar/buttons/divider.png'
		]);
		
		mango.utils.preload(['images/layout/footer/divider.png']);
		
				
		mango.utils.preload([
			'images/layout/bg.png',
			'images/layout/content/box/actions-bg.png',
			'images/layout/content/box/bg.png',
			'images/layout/content/box/header-bg.png',
			'images/layout/content/box/menu-active-bg.png',
			'images/layout/content/box/menu-arrow.png',
			'images/layout/content/box/menu-bg.png',
			'images/layout/content/box/menu-item-bg-hover.png',
			'images/layout/content/box/menu-item-bg.png',
			'images/layout/content/box/tab-hover.png',
			'images/layout/content/toolbar/bg-shortcuts.png',
			'images/layout/content/toolbar/bg.png',
			'images/layout/content/toolbar/divider.png',
			'images/layout/content/toolbar/popup-arrow.png',
			'images/layout/content/toolbar/popup-header.png',
			'images/layout/content/toolbar/user/arrow-normal.png',
			'images/layout/content/toolbar/user/avatar-bg.png',
			'images/layout/content/toolbar/user/avatar.png',
			'images/layout/content/toolbar/user/bg-hover.png',
			'images/layout/content/toolbar/user/bg-menu-hover.png',
			'images/layout/content/toolbar/user/counter.png'
		]);
		
		
		mango.utils.preload([
			'images/elements/alert-boxes/bg-error.png',
			'images/elements/alert-boxes/bg-information.png',
			'images/elements/alert-boxes/bg-note.png',
			'images/elements/alert-boxes/bg-success.png',
			'images/elements/alert-boxes/bg-warning.png',
			'images/elements/alert-boxes/error.png',
			'images/elements/alert-boxes/information.png',
			'images/elements/alert-boxes/note.png',
			'images/elements/alert-boxes/success.png',
			'images/elements/alert-boxes/warning.png'
		]);
		
		mango.utils.preload([
			'images/elements/breadcrumb/bg-active.png',
			'images/elements/breadcrumb/bg-hover.png',
			'images/elements/breadcrumb/divider-active.png',
			'images/elements/breadcrumb/divider-hover.png'
		]);
		
		mango.utils.preload([
			'images/elements/headerbuttons/bg-active.png',
			'images/elements/headerbuttons/bg-hover.png'
		]);
	
		mango.utils.preload([
			'images/elements/autocomplete/el-bg-hover.png'
		]);
		
		mango.utils.preload([
			'images/elements/calendar/arrow-hover-bg.png'
		]);
		
		mango.utils.preload(['images/elements/charts/hover-bg.png']);
		
		mango.utils.preload([
			'images/elements/messages/button-active-bg.png',
			'images/elements/messages/button-hover-bg.png'
		]);
		...
		mango.utils.preload([
			'images/elements/mail/actions-bg.png',
			'images/elements/mail/button-bg-disabled.png',
			'images/elements/mail/button-bg-hover.png',
			'images/elements/mail/button-bg.png',
			'images/elements/mail/button-red-bg-hover.png',
			'images/elements/mail/button-red-bg.png',
			'images/elements/mail/button-red-disabled.png',
			'images/elements/mail/hover-bg.png',
			'images/elements/mail/mail.png',
			'images/elements/mail/text-arrow.png',
			'images/elements/mail/text-bg.png'
		]);
		
		mango.utils.preload([
			'images/elements/fullstats/list/hover-bg.png',
			'images/elements/fullstats/simple/a-active.png',
			'images/elements/fullstats/simple/a-hover.png'
		]);
		
		mango.utils.preload([
			'images/elements/checkbox/checked-active.png',
			'images/elements/checkbox/checked-disabled.png',
			'images/elements/checkbox/checked-hover.png',
			'images/elements/checkbox/checked-normal.png',
			'images/elements/checkbox/unchecked-active.png',
			'images/elements/checkbox/unchecked-disabled.png',
			'images/elements/checkbox/unchecked-hover.png',
			'images/elements/checkbox/unchecked-normal.png'
		]);
		
		mango.utils.preload([
			'images/elements/radiobutton/checked-active.png',
			'images/elements/radiobutton/checked-disabled.png',
			'images/elements/radiobutton/checked-hover.png',
			'images/elements/radiobutton/checked-normal.png',
			'images/elements/radiobutton/unchecked-active.png',
			'images/elements/radiobutton/unchecked-disabled.png',
			'images/elements/radiobutton/unchecked-hover.png',
			'images/elements/radiobutton/unchecked-normal.png'
		]);
		
		mango.utils.preload([
			'images/elements/colorpicker/arrow.png',
			'images/elements/colorpicker/bg.png'
		]);
		
		mango.utils.preload([
			'images/elements/forms/icon-error.png',
			'images/elements/forms/icon-success.png',
			'images/elements/forms/tooltip-error-arrow.png',
			'images/elements/forms/tooltip-error.png'
		]);
		
		mango.utils.preload([
			'images/elements/profile/change-active-bg.png',
			'images/elements/profile/change-hover-bg.png'
		]);
		
		mango.utils.preload([
			'images/elements/search/arrow.png',
			'images/elements/search/glass.png',
			'images/elements/search/list-hover.png',
			'images/elements/search/loading.gif'
		]);

		mango.utils.preload([
			'images/elements/select/bg-active.png',
			'images/elements/select/bg-hover.png',
			'images/elements/select/bg-right-hover.png',
			'images/elements/select/list-hover-bg.png'
		]);
		
		mango.utils.preload([
			'images/elements/settings/header-bg.png',
			'images/elements/settings/header-current-bg.png',
			'images/elements/settings/header-hover-bg.png',
			'images/elements/settings/seperator-current-left.png',
			'images/elements/settings/seperator-current-right.png',
			'images/elements/settings/seperator.png'
		]);

		mango.utils.preload([
			'images/elements/slide-unlock/lock-slider.png'
		]);
		
		mango.utils.preload([
			'images/elements/spinner/arrow-down-active.png',
			'images/elements/spinner/arrow-down-hover.png',
			'images/elements/spinner/arrow-up-active.png',
			'images/elements/spinner/arrow-up-hover.png',
			'images/elements/table/pagination/active.png',
			'images/elements/table/pagination/disabled.png',
			'images/elements/table/pagination/hover.png',
			'images/elements/table/toolbar/hover.png',
			'images/elements/table/sorting-asc.png',
			'images/elements/table/sorting-desc.png',
			'images/elements/table/sorting.png'
		]);
		
		mango.utils.preload([
			'images/elements/tags/bg.png',
			'images/elements/tags/left.png'
		]);
		
		mango.utils.preload([
			'images/elements/to-top/active.png',
			'images/elements/to-top/hover.png',
			'images/elements/to-top/normal.png'
		]);
		
		mango.utils.preload(['images/elements/tooltips/bg.png']);
		
		mango.utils.preload([
			'images/elements/upload/bg-hover.png',
			'images/elements/upload/bg-normal.png'
		]);
		
		mango.utils.preload([
			'images/elements/wizard/arrow-current.png',
			'images/elements/wizard/arrow-error.png',
			'images/elements/wizard/arrow-normal.png',
			'images/elements/wizard/arrow-success.png',
			'images/elements/wizard/bg-current.png',
			'images/elements/wizard/bg-error.png',
			'images/elements/wizard/bg-normal.png',
			'images/elements/wizard/bg-success.png',
			'images/elements/wizard/bg.png'
		]);
		
		mango.utils.preload([
			'images/external/chosen-sprite.png'
		]);
		...
		mango.utils.preload([
			...
			'images/external/colorpicker/colorpicker_hsb_h.png',
			'images/external/colorpicker/colorpicker_hsb_s.png',
			'images/external/colorpicker/colorpicker_indic.gif',
			'images/external/colorpicker/colorpicker_overlay.png',
			'images/external/colorpicker/colorpicker_rgb_b.png',
			'images/external/colorpicker/colorpicker_rgb_g.png',
			'images/external/colorpicker/colorpicker_rgb_r.png',
			'images/external/colorpicker/colorpicker_select.gif',
			'images/external/colorpicker/colorpicker_submit.png',
			'images/external/colorpicker/custom_background.png',
			'images/external/colorpicker/custom_hex.png',
			'images/external/colorpicker/custom_hsb_b.png',
			'images/external/colorpicker/custom_hsb_h.png',
			'images/external/colorpicker/custom_hsb_s.png',
			'images/external/colorpicker/custom_indic.gif',
			'images/external/colorpicker/custom_rgb_b.png',
			'images/external/colorpicker/custom_rgb_g.png',
			'images/external/colorpicker/custom_rgb_r.png',
			'images/external/colorpicker/custom_submit.png',
			'images/external/colorpicker/select.png',
			'images/external/colorpicker/select2.png',
			'images/external/colorpicker/slider.png'
		]);
		
		mango.utils.preload([
			'images/external/editor/buttons.gif',
			'images/external/editor/toolbar.gif'
		]);
		
		mango.utils.preload([
			'images/external/explorer/arrows-active.png',
			'images/external/explorer/arrows-normal.png',
			'images/external/explorer/crop.gif',
			'images/external/explorer/dialogs.png',
			'images/external/explorer/icons-big.png',
			'images/external/explorer/icons-small.png',
			'images/external/explorer/logo.png',
			'images/external/explorer/progress.gif',
			'images/external/explorer/quicklook-bg.png',
			'images/external/explorer/quicklook-icons.png',
			'images/external/explorer/resize.png',
			'images/external/explorer/spinner-mini.gif',
			'images/external/explorer/toolbar.png'
		]);
		
		mango.utils.preload([
			'images/external/gallery/blank.gif',
			'images/external/gallery/fancybox_buttons.png',
			'images/external/gallery/fancybox_loading.gif',
			'images/external/gallery/fancybox_sprite.png'
		]);
		
		mango.utils.preload([
			'images/external/jquery-ui/ui-bg_flat_0_000000_40x100.png',
			'images/external/jquery-ui/ui-bg_flat_30_000000_40x100.png',
			'images/external/jquery-ui/ui-bg_flat_65_e3e3e3_40x100.png',
			'images/external/jquery-ui/ui-bg_flat_75_ffffff_40x100.png',
			'images/external/jquery-ui/ui-bg_glass_55_fbf9ee_1x400.png',
			'images/external/jquery-ui/ui-bg_highlight-hard_100_f0f0f0_1x100.png',
			'images/external/jquery-ui/ui-bg_highlight-soft_100_e8e8e8_1x100.png',
			'images/external/jquery-ui/ui-bg_highlight-soft_75_b3bfcb_1x100.png',
			'images/external/jquery-ui/ui-bg_inset-soft_95_fef1ec_1x100.png',
			'images/external/jquery-ui/ui-icons_222222_256x240.png',
			'images/external/jquery-ui/ui-icons_2e83ff_256x240.png',
			'images/external/jquery-ui/ui-icons_3a4450_256x240.png',
			'images/external/jquery-ui/ui-icons_454545_256x240.png',
			'images/external/jquery-ui/ui-icons_888888_256x240.png',
			'images/external/jquery-ui/ui-icons_cd0a0a_256x240.png'
		]);
		
		mango.utils.preload([
			'images/external/uploader/backgrounds.gif',
			'images/external/uploader/buttons-disabled.png',
			'images/external/uploader/buttons.png',
			'images/external/uploader/delete.gif',
			'images/external/uploader/done.gif',
			'images/external/uploader/error.gif',
			'images/external/uploader/throbber.gif',
			'images/external/uploader/transp50.png'
		]);
		
		mango.utils.preload([
			'images/jquery-ui/accordion-header-active.png',
			'images/jquery-ui/accordion-header-hover.png',
			'images/jquery-ui/accordion-header.png',
			'images/jquery-ui/datepicker/arrow-left.png',
			'images/jquery-ui/datepicker/arrow-right.png',
			'images/jquery-ui/datepicker/button-bg.png',
			'images/jquery-ui/datepicker/button-hover-bg.png',
			'images/jquery-ui/datepicker/button-seperator.png',
			'images/jquery-ui/datepicker/day-current.png',
			'images/jquery-ui/datepicker/day-hover.png',
			'images/jquery-ui/datepicker/days-of-week-bg.png',
			'images/jquery-ui/datepicker/header-bg.png',
			'images/jquery-ui/datepicker/time-bg.png',
			'images/jquery-ui/datepicker/top-arrow.png',
			'images/jquery-ui/dialog-titlebar-close-hover.png',
			'images/jquery-ui/dialog-titlebar.png',
			'images/jquery-ui/loading.gif',
			'images/jquery-ui/progressbar/bg.png',
			'images/jquery-ui/progressbar/fill-blue-small.png',
			'images/jquery-ui/progressbar/fill-blue.gif',
			'images/jquery-ui/progressbar/fill-blue.png',
			'images/jquery-ui/progressbar/fill-grey.gif',
			'images/jquery-ui/progressbar/fill-grey.png',
			'images/jquery-ui/progressbar/fill-orange-small.png',
			'images/jquery-ui/progressbar/fill-orange.gif',
			'images/jquery-ui/progressbar/fill-orange.png',
			'images/jquery-ui/progressbar/fill-red-small.png',
			'images/jquery-ui/progressbar/fill-red.gif',
			'images/jquery-ui/progressbar/fill-red.png',
			'images/jquery-ui/slider/bg-range.png',
			'images/jquery-ui/slider/bg.png',
			'images/jquery-ui/slider/disabled-bg-range.png',
			'images/jquery-ui/slider/disabled-bg.png',
			'images/jquery-ui/slider/disabled-picker.png',
			'images/jquery-ui/slider/disabled-vertical-bg-range.png',
			'images/jquery-ui/slider/disabled-vertical-bg.png',
			'images/jquery-ui/slider/disabled-vertical-picker.png',
			'images/jquery-ui/slider/picker.png',
			'images/jquery-ui/slider/vertical-bg-range.png',
			'images/jquery-ui/slider/vertical-bg.png',
			'images/jquery-ui/slider/vertical-picker.png'
		]);
